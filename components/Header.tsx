import { Building2, Bell, User, Menu, Home, BarChart3, FileText, Calculator, Zap } from "lucide-react";
          ...
          <div className="flex items-center space-x-3">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="bg-slate-800 border-gray-700">
                ...
                <DropdownMenuItem className="text-gray-300 hover:text-red-400 hover:bg-gray-700 focus:bg-gray-700">
                  Sign Out
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
